...
class DiagramFactory:
    ...
    @classmethod
    def make_text(cls, x, y, text, font_size=12):
        return cls.Text(x, y, text, font_size)
...
font-family="sans-serif" font-size="{font_size}">{text}</text>"""

    SVG_SCALE = 20

    class Diagram:
        def __init__(self, width, height):
            px_width = width * SvgDiagramFactory.SVG_SCALE
            px_height = height * SvgDiagramFactory.SVG_SCALE
    ...
    class Text:
        def __init__(self, x, y, text, font_size):
            x *= SvgDiagramFactory.SVG_SCALE
            y *= SvgDiagramFactory.SVG_SCALE
            font_size *= SvgDiagramFactory.SVG_SCALE // 10
